  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetListOfIngredientsRow:
            return GetListOfIngredientsRow(data);
          case GetListOfIngredientsFromMealRow:
            return GetListOfIngredientsFromMealRow(data);
          case ListOfMealsRow:
            return ListOfMealsRow(data);
          default:
            return null;
        }
